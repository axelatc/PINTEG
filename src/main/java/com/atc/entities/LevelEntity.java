...
@Entity
@Table(name = "levels", schema = "shapp", catalog = "")
public class LevelEntity {
    ...
    private Collection<ExerciseEntity> exercisesById;
    ...
    @OneToMany(mappedBy = "levelsByLevelId")
    public Collection<ExerciseEntity> getExercisesById() {
        return exercisesById;
    }

    public void setExercisesById(Collection<ExerciseEntity> exercisesById) {
