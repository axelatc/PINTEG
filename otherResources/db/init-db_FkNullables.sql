...
(16, 'permissions:delete', 'Permet de supprimer une permission.'),
(17, 'measures:new', 'Permet de créer une nouvelle mesure'),
(18, 'measures:read', 'Permet de consulter les détails de n\'importe quelle mesure.'),
(19, 'measures:edit', 'Permet d\'éditer les détails de n\'importe quelle mesure.'),
(20, 'measures:delete', 'Permet de supprimer une mesure.'),
(21, 'measurands:new', 'Permet de créer un nouveau type de mesure'),
(22, 'measurands:read', 'Permet de consulter les détails de n\'importe quel type de mesure.'),
(23, 'measurands:edit', 'Permet d\'éditer les détails de n\'importe quel type de mesure.'),
(24, 'measurands:delete', 'Permet de supprimer un type de mesure.'),
(25, 'measurands:assign_unit', 'Permet d\'assigner une unité à un type de mesure.'),
(26, 'subscriptions:consult', 'Permet de consulter son abonnement'),
